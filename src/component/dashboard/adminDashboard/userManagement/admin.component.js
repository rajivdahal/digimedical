...
const CreateAdmin = (props) => {
    ...
    const getAllAdmin = async () => {
        await httpClient.GET("admin/all", false, true)
            .then(resp => {
                console.log(resp)
    ...
    const createAdmin = (values) => {
        ...
        try {
            ...
            httpClient.POST("admin/create", formData, false, true, "formdata")
                .then(resp => {
                    let data = resp.data.data;
                    if (resp.data.status) {
                        console.log(data);
    ...
    const editAdminInfo = (values) => {
        ...
        try {
            ...
            httpClient.PUT("admin/update/" + adminId, formData, false, true, "formdata")
                .then(resp => {
                    if (resp.data.status) {
                        notify.success(resp.data.message)
                        getAllAdmin();
    ...
    const changeAdminStatus = () => {
        ...
        httpClient.PUT("admin/change/" + adminId + "/" + status, {}, null, true)
            .then(resp => {
                if (resp.data.status) {
                    notify.success(resp.data.message)
                    setLoading(false)
        ...
        <div>
            <Container>
                        ...
                        <Col md={6}>
                            <Row>
                                <Col md={5}>
                                    ...
                                    <input onChange={(e) => handleChangeImage(e)} type="file" name="adminImage"
                ...
                <MaterialTable
                    ...
                    actions={[
                        ...
                        },
                        {
                            ...
                            onClick: (e, rowData) => { handleDeactivateAdmin(e, rowData) }
                        },
                ...
                <Modal show={showModal} onHide={handleClose}>
                    <Modal.Header >
                        <Modal.Title><b>Admin Status</b></Modal.Title>
                    </Modal.Header>
                    <Modal.Body >Do you really want to change this admin status ?</Modal.Body>
                    <Modal.Footer>
                        {loading == true ?
                            <Cliploader isLoading={loading} />
                            :
                            <div>
                                ...
                                <Button variant="info" style={{ marginLeft: '10px' }} onClick={changeAdminStatus}>
                                    Change Status
                                </Button>
                            </div>
                        }
