...
const Userdashboard = (props) => {
  ...
  useEffect(() => {
    ...
    httpClient
      .GET("get-user-pending-appointments", false, true)
      .then((resp) => {
    ...
    navigator.geolocation.getCurrentPosition(function (done, err) {
      if (done) {
        ...
        http
          .get(
            `http://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=47056d723585bc46aefd6a866267557a`
          )
          .then((resp) => {
