        ...
        <div className="newdash_dash1">
          ...
          <div className="newdash_dash1_dashboard">
            <div className="newdash_dash1_cont1">
              ...
              <Link to="/dashboard/viewappointment" style={{ textDecoration: "none", color: "inherit" }}>
                ...
                <Link to="/dashboard/bookappointment" style={{ textDecoration: "none", color: "inherit" }}>
          ...
          <div className="newdash_dash1_dashboard">
            <div className="newdash_dash1_cont1">
              ...
              <div className="newdash_dash1_cont2">
              <Link to="/dashboard/lab-test" style={{ textDecoration: "none", color: "inherit" }}>
                <p style={{cursor:"pointer"}}>Book Lab Tests</p>
                </Link>
                <Link to="/dashboard/view-lab-test" style={{ textDecoration: "none", color: "inherit" }}>
                <p style={{cursor:"pointer"}}>My Lab Tests</p>
                </Link>
              </div>
            </div>
          </div>
          <div className="newdash_dash1_dashboard" onClick={loadHospitals} style={{cursor:"pointer"}}>
            <div className="newdash_dash1_cont1">
