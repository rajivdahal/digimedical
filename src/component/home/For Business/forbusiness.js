...
import Ooscomponent from "../Our Services/ouros.component";
...
function forbusiness() {
  return (
    <div className="forbusiness-main-div">
      <Navbar />
      <Root
        style={{
          ...
          <div className="serv-passages">
            ...
            <div className="serv-boxes">
              <p className="serv-text">
                Productivity crisis, Absenteeism and the cost related to it,
                etc. are increasing in most of the parts of world as suggested
                by IMF, ILO and other reputed International Organisations. An
                Employer has to bear the loss resulting from low productivity,
                absenteeism, etc. Employers know that by proactively supporting
                the health of their employees they’re able to reduce
                absenteeism, increase engagement and improve productivity. The
                focus has shifted to a broader view of workforce health,
                including the physical, mental, work and life components of
                health.
              </p>
            </div>
            <p className="questionheads">
            ...
            <div className="serv-boxes">
              <p className="serv-text">
                The relevant question is, what is a lack of prioritizing it
                going to cost you? Rising healthcare costs and health-related
                absences are constant challenges for employers. In the U.S., the
                costs of poor employee health totals $530 billion a year for
                employers. This cost includes things such as lost productivity
                due to worker absence, chronic conditions that cause impaired
                performance, and workers’ compensation.<br></br>
                <br></br>
                ...
                its people need to be mentally and physically healthy — after
                all, it’s hard to be productive when you’re not well.<br></br>
                <br />
                Taking care of your employees’ health in the workplace is not
                only beneficial to them; it also creates an effective and
                efficient working environment that benefits the business.
                Employee health and productivity go hand in hand: A mentally and
                physically healthy individual is more optimistic, creative, and
                motivated. Digi Medical provides annual employee health
                screening tests and health services for your employees to make
                your staff aware of underlying health issues and prevent bigger
            ...
            <p className="questionheads">Facts About Digimedical</p>
            <div className="serv-boxes">
              <ul className="serv-text">
                <li>
                ...
                <li>
                  Rs. 1 spent on prevention saves Rs. 133 in absenteeism costs
                  and Rs. 6.62 in healthcare costs. – (Source: ASSOCHAM)
                </li>
                <li>
                  Preventive Healthcare and Wellness Programs can change
                  employee behaviour, improve their bio-metric risk profile and
                  work productivity. – (Source: ASSOCHAM){" "}
                </li>
                <li>
                ...
                <li>
                  ...
                  issues require a patient to visit a doctor. – (Source:
                  National Ambulatory Medical Care Survey 2006)
                </li>
                <li>
                  As of Sept., 2016, total healthcare personnel including
                  doctors, nurses and midwives in Nepal was 3.15 per 1,000
                  population. –{" "}
                </li>
