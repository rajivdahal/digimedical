...
const handleSubmit=(value,{ resetForm })=>{
  ...
  httpClient.POST("service-booking/create-external-booking",value)
  .then(resp=>{
    notify.promise("Success, you will be notified via phone or E-mail please check your email soon")
    resetForm()

  })
  .catch(err=>{
    if(err.response.data.message=="Email already exists"){
      notify.error(err.response.data.message+" please login to book service")
      resetForm()
    ...
    <Root>
      ...
      >
        ...
        <button
          ...
          style={{ gridColumnStart: "1", gridColumnEnd: "3" ,cursor:"pointer",zIndex:"10"}}
