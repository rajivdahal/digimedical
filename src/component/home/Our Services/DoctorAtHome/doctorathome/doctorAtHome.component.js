        ...
        <div className="serv-passages">
          ...
          <div className="serv-boxes">
            <p className="serv-text">
              It is said that Health is Wealth. So, to take care of our health,
              we need to consult a doctor once in a while for general health
              check-up, seasonal flu and fever, acute diseases, chronic illness
              and more. In many situations, we are physically weak and visiting
              a doctor in that condition seems like a difficult task. We’d
              prefer a doctor visiting us at our home for consultation rather
              than we having to visit them. Also, at the doctor’s clinic/
              hospital there are different kinds of patients which makes us even
              more vulnerable to other diseases. <br></br>
              ...
              hospitals & nursing homes. The doctors making home visits are
              highly qualified and experienced professionals. They provide
              medical consultation and our Client Health Service Department will
              help you throughout your recovery process. Furthermore, by
              availing “Doctor at Home” service, you will be treated in the
              comfort of your home, surrounded by your family members. “Doctor
              at Home” service can be of great convenience for all.
            </p>
          </div>
          ...
          <div className="serv-boxes">
            <p className="serv-text">
              ...
              experienced doctors at home with doctors from various medical
              fields to take care of all your health needs. Some of the
              Specialist Doctors with us are:
            </p>
          ...
          <div className="serv-boxes">
            <ol className="serv-text">
              ...
              <li>
                ...
                provided at your home and our consultation charges are lower or
                at par with the hospital visit charges.
              </li>
              <li>
