      ...
      <div className="ourserv-cont-main1">
        <div className="serv-passages">
          ...
          <p className="questionheads">
            When do clients need Digi medical for an MRI/CT scan?{" "}
          </p>
          <div className="serv-boxes">
            <p className="serv-text">
              This high-tech test is a key to diagnose and treat many health
              conditions that would otherwise remain hidden. While CT scans or
              digital X-rays produce two-dimensional images, Magnetic Resonance
              Imaging renders three-dimensional images or even slices of
              internal organs such as the brain or liver. You can book MRI/CT
              Scan service by just downloading our App and experience the
              hassle-free journey with Digi Medical towards your health
              improvement.
            </p>
          </div>
          <p className="questionheads">
            Benefits to the client from taking CT/MRI scan services from Digi
            medical
          </p>
          <div className="serv-boxes">
            <p className="serv-text">
              Digi Medical is in collaboration with renowned CT/MRI scan service
              centres. Thus, clients can have benefits as follows:
            </p>
            <ul className="serv-text">
              <li> Services are convenient </li>
              <li>
                {" "}
                Saves time and reduce stress related to searching for a reliable
                service centre.
              </li>
              <li> Accurate reports</li>
              <li> Accessible and cost effective</li>
              <li> Hassle free process for client and family members.</li>
            </ul>
          </div>
        </div>
