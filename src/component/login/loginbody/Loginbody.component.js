...
const Loginbodycomponent = (props) => {
  const fromexternaluser = props.history.location.fromexternaluser
    ? props.history.location.fromexternaluser
    : false;
  const externaluseremail = props.history.location.email
    ? props.history.location.email
    : null;
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      setisLoading(true);
      httpClient
        .UPLOAD("POST", "oauth/token", values, "password", null)
        .then((resp) => {
    ...
    validate: (values) => {
      ...
      if (!values.username) {
        ...
        !/^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(values.username)
      ) {
        ...
        <div className="container">
          <div className="row adjust-height">
            ...
            <div className="col-md-6 adj-form ">
              <form
                className="login-form login-form-body"
              ...
              >
                ...
                <p style={{ color: "blue" }}>
                  {fromexternaluser
                    ? `Please check your email and login with OTP provided at`
                    : null}
                </p>
                ...
                <div className="row">
                  ...
                  <div className="col-md-12">
                    <div className="form-group select-label">
                      ...
                      {ispassword ? (
                        <i
                          class="fas fa-eye eye-to-see-password"
                          onClick={vieworhidepassword}
                        ></i>
                      ) : (
                        <i
                          class="fas fa-eye-slash eye-to-see-password"
                          onClick={vieworhidepassword}
                        ></i>
                      )}
                  ...
                  <div className="sign-btn text-center w-100 mt-2">
                    ...
                    <p
                      className="text-center w-100 pt-3"
...
export const Loginbody = connect(
  mapStateToProps,
  mapDispatchToProps
)(Loginbodycomponent);
