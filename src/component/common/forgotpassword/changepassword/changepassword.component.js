...
export const Changepassword = (props) => {
  ...
  return (
    <>
      ...
      {
        props.location.pathname === "/dashboard/settings/change-password" ? <div className="changepassword-body">
          <div className="changepassword-box">
            <h1>{props.location.fromexternaluser ? "Enter Password" : "Change Password"}</h1>
            <form action="" className="change_pass_form" onSubmit={Formik.handleSubmit}>
              ...
              <div className="but_chang_pass">
                <button id="cancel_chang_pass" onClick={handleCancel}>Cancel</button>
                <button id="submit_chang_pass" type="submit">Submit</button>
              </div>
            </form>
          ...
          <form className="forgotpassword" onSubmit={Formik.handleSubmit}>
            ...
            <label htmlFor="password" style={{ marginTop: "20px" }}>New Password<span style={{ color: 'red' }}>*</span></label>
