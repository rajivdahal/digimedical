...
export default function ExternalBookingPayment(props) {
    console.log("inside external booking payment")
  ...
  useEffect(() => {
    ...
    if(digiDoctorBooking.emailAlreadyExistsMessage){
      closePaymentPopUp()
    }
    ...
    httpClient
      ...
      .then((resp) => {
        ...
        if(localStorage.getItem("dm-access_token")){
           ...
           return  notify.success("Appointment Successfully created");
        }
          ...
          <div className="doc-pay-pop-body">
            <div className="doc-pay-appoint-det1">
              ...
              <p id="pay-appoint-det-p">
                {formatDate(digiDoctorBooking.digiDoctorAppointmentDate ||digiDoctorBooking.digiDoctorInfo.appointmentDate)}
              </p>
            </div>
            <div className="doc-pay-doc-serv">
              ...
              <div className="payapp-det2">
                ...
                <p id="pay-appoint-det-p2">
                  {
                    digiDoctorBooking.digiDoctorInfo?
                        digiDoctorBooking.digiDoctorInfo.servicename ||digiDoctorBooking.digiDoctorInfo.specialist
                        ?digiDoctorBooking.digiDoctorInfo.servicename ||digiDoctorBooking.digiDoctorInfo.specialist
                        :"need yo update from backend"
                    :"need yo update from backend"
                   }
                </p>
              </div>
            ...
            <div className="pay-ctlt-checkbox">
              <div className="ctlt_institute_radio">
                {
                  digiDoctorBooking.digiDoctorInfo?
                     digiDoctorBooking.digiDoctorInfo.doctorService||digiDoctorBooking.digiDoctorInfo.digiService?
                       digiDoctorBooking.digiDoctorInfo.doctorService||digiDoctorBooking.digiDoctorInfo.digiService.map((item,index)=>{
                        return (
